			...
			<div class="scroll-sidebar">
				...
				<nav class="sidebar-nav">
					<ul id="sidebarnav">
						...
						<li class="sidebar-item"><a href="<?= site_url('scene') ?>" class="sidebar-link"><i class="mdi mdi-table"></i><span class="hide-menu"> Data Scene</span></a></li>
						<li class="sidebar-item"><a href="<?= site_url('hotspot') ?>" class="sidebar-link"><i class="mdi mdi-table"></i><span class="hide-menu"> Data Hotspot</span></a></li>
						<li class="sidebar-item"><a href="<?= site_url('galery') ?>" class="sidebar-link"><i class="mdi mdi-image"></i><span class="hide-menu"> Data Galery</span></a></li>
